...
export function ChatbotBase({ reset, usuarioLogado, setModalAberto }) {
          ...
          <>
            {etapa === 0 &&
              <div className='botaoIniciarPai'>
                <button
                  className="botaoDenuncia" onClick={() => { usuarioLogado ? fazerDenuncia : setModalAberto(true) }}>Fazer denúncia</button>
                <button
